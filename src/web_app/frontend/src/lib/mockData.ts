...
export const RECENT_INSIGHTS_ALERTS = [
  {
    ...
    desc: 'You have unrealized losses that could offset gains. Consider harvesting.',
    timeAgo: '2h ago',
    dotColor: '#f59e0b',
    chatPrompt: 'Explain tax-loss harvesting and how I can use my unrealized losses to offset capital gains this year.',
    actionLabel: 'Ask about tax-loss harvesting →',
  },
  {
    id: '2',
    type: 'rebalance',
    title: 'Portfolio Rebalancing',
    desc: 'Your tech allocation may have drifted above target. Review your current holdings.',
    timeAgo: '5h ago',
    dotColor: '#3b82f6',
    chatPrompt: 'Analyze my portfolio allocation and tell me if I need to rebalance. Which positions are over or underweight?',
    actionLabel: 'Ask about rebalancing →',
  },
  {
    id: '3',
    type: 'dividend',
    title: 'Dividend Income',
    desc: 'Track dividend income from your ETF and stock holdings.',
    timeAgo: '1d ago',
    dotColor: '#10b981',
    chatPrompt: 'What is dividend investing and how can I build a dividend income portfolio? What are the best dividend ETFs?',
    actionLabel: 'Learn about dividends →',
  },
];
